...
<div class="bg-gray-50 dark:bg-dark-700 rounded-lg p-6">
    <div class="flex items-center justify-between">
        <div class="flex items-center">
            ...
            <div class="flex items-center gap-4"><!-- Encabezado con información básica -->
<div class="bg-gray-50 dark:bg-dark-700 rounded-lg p-6">
    <div class="flex items-center justify-between">
        <div class="flex items-center">
            <!-- Logo del equipo -->
...
<!-- Fechas de registro -->
<div class="bg-gray-50 dark:bg-dark-700 rounded-lg p-4">
    <h4 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">Historial</h4>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <p class="text-sm text-gray-600 dark:text-gray-400">Fecha de registro</p>
            <p class="font-medium text-gray-800 dark:text-white" 
            x-text="new Date(selectedEquipo.created_at).toLocaleDateString('es-ES', { day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' })">
            </p>
        </div>
        <div x-show="selectedEquipo.updated_at !== selectedEquipo.created_at">
            <p class="text-sm text-gray-600 dark:text-gray-400">Última actualización</p>
            <p class="font-medium text-gray-800 dark:text-white" 
            x-text="new Date(selectedEquipo.updated_at).toLocaleDateString('es-ES', { day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' })">
            </p>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-100 dark:border-blue-900/30">
        ...
        <div class="space-y-2 text-sm">
            <div class="flex justify-between">
                <span class="text-blue-600 dark:text-blue-400">Juegos como local:</span>
                <span class="text-blue-800 dark:text-blue-300 font-medium" x-text="selectedEquipo.juegos_como_local?.length || 0"></span>
            </div>
            <div class="flex justify-between">
                <span class="text-blue-600 dark:text-blue-400">Juegos como visitante:</span>
                <span class="text-blue-800 dark:text-blue-300 font-medium" x-text="selectedEquipo.juegos_como_visitante?.length || 0"></span>
            </div>
            <div class="flex justify-between">
                <span class="text-blue-600 dark:text-blue-400">Total de juegos:</span>
    ...
    <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 border border-green-100 dark:border-green-900/30">
        <h4 class="text-lg font-semibold text-green-800 dark:text-green-400 mb-3 flex items-center">
            <svg class="w-5 h-5 mr-2 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
            </svg>
            Estadísticas de Jugadores
        ...
        <div class="space-y-2 text-sm">
            <div class="flex justify-between">
                <span class="text-green-600 dark:text-green-400">Total de jugadores:</span>
                <span class="text-green-800 dark:text-green-300 font-medium" x-text="selectedEquipo.jugadores?.length || 0"></span>
            </div>
            <div class="flex justify-between">
                <span class="text-green-600 dark:text-green-400">Jugadores activos:</span>
